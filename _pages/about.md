      ...
      <article class="publication-row">
        ...
        <div>
          ...
          <div class="publication-row__links">
            {% if post.paperurl %}<a href="{{ post.paperurl }}">Publication</a>{% endif %}
...
<section class="home-section currently" aria-labelledby="currently-heading">
  <div class="section-heading">
    ...
    <a class="text-link" href="{{ '/currently/' | relative_url }}">Activity log</a>
  </div>
  <div class="currently-grid">
    ...
    <article class="currently-card">
      ...
      {% endfor %}
      {% if item.profile_url %}<a class="currently-card__profile" href="{{ item.profile_url }}">{{ item.profile_label }}</a>{% endif %}
    </article>
    {% endfor %}
  </div>
</section>
